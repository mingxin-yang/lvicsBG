...
public class ZoomOutButton extends ImageButton {
    ...
    int mPlusColor;
    int mColorPressed;
    public ZoomOutButton(Context context) {
        super(context);
    }

    public ZoomOutButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context,attrs);
    }

    public ZoomOutButton(Context context, AttributeSet attrs, int defStyleAttr) {
